    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('pegawai/store') }}" method="post"> @csrf
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3">
                                    ...
                                    <input type="date" class="form-control" name="tgl_lahir" placeholder=" _" value="{{ old('tgl_lahir') }}">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group input-group-outline my-3">
                                    ...
                                    <input type="date" class="form-control" name="tgl_masuk" placeholder=" _" value="{{ old('tgl_masuk') }}">
                                </div>
